...
console.log(`diet of velociraptor: ${velociraptor.diet}`);

// How long was a stegosaurus?
console.log(`Length of stegosaurus: `, stegosaurus.length);

// What time period did tyrannosaurus live in?
console.log(`tyrannosaurus lived in the ${tyrannosaurus.period}`);
...
console.log("GRADUATE UNIVERSITIES");
...
console.log("LOWERCASE ANIMAL NAMES");
...
console.log("ANIMAL POPULATION LESS THAN 5");
